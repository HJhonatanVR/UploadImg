...
class _StoragePageState extends State<StoragePage> {
  ...
  Future<UploadTask> upload(String path) async {
    ...
    try {
      ...
      throw Exception('Error en la subida de imagen: ${e.code}');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: uploading ? Text('${total.round()}% enviado') : const Text('UPEU - Subir Imagenes'),
        actions: [
          uploading
              ? const Padding(
      ...
      body: loading
          ...
          : Padding(
              ...
              child: arquivos.isEmpty
                  ? const Center(child: Text('Seleccione una imagen de su galeria.'))
                  : ListView.builder(
